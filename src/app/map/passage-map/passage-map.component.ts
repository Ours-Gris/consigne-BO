...
@Component({
  selector: 'app-passage-map',
  templateUrl: './passage-map.component.html',
  styleUrls: ['./passage-map.component.css']
})
export class PassageMapComponent implements AfterViewInit {
    private map!: L.Map;
